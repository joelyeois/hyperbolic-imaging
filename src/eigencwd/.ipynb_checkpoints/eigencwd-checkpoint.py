...
Modified from (Sroubek, 2016, Decomposition of Space-Variant Blur in Image Deconvolution)
Original code from https://zoi.utia.cas.cz/decomposition
"""
...
class EigenCWD:
    '''
    A class for EigenCWD which performs spatially-varying deblurring.
    '''
    ...
    def eigencwd(self, eigenpsfs, eigencoeffs, niter=100, alpha=1, mu=1e5,
                 n_components=torch.inf, init=None):
        """
        Performs the eigenCWD algorithm iterations.
